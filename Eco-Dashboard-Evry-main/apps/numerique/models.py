...
class NumeriqueEmissionFactor(models.Model):
    ...
    source = models.CharField(max_length=200, default="Base Empreinte® ADEME 2024", blank=True)
...
class EquipementNumerique(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Facteur Elec France 2024 (approx 0.052 kg/kWh) - Pourrait aussi être en DB (Module Bâtiment)
        FACTEUR_ELEC = 0.052 
